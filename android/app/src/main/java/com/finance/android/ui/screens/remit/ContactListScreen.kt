...
@Composable
fun ContactListScreen(modifier: Modifier = Modifier.background(Color.White)) {
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            list.forEach{
                 ContactItem(name = it.name, number = it.phoneNumber[0].toString(), avatar = it.avatar, modifier = Modifier) }
